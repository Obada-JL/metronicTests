...
import {StepperComponent} from './stepperCompontnt'
import {Form, Formik, FormikValues} from 'formik'
import {createAccountSchemas, ICreateAccount, inits} from './wizardHelpers'
                  ...
                  <div className='d-flex flex-stack pt-15'>
                    <div className='mr-2'>
                      ...
                      >
                        ...
                        <i className="ki ki-arrow-left fs-3 ms-2 me-0"></i>
                        Back
                      </button>
                    </div>
                    ...
                    <div>
                      <button type='submit' className='btn btn-lg btn-primary me-3'>
                        <span className='indicator-label'>
                          ...
                          <i className="ki ki-arrow-right fs-3 ms-2 me-0"></i>
                        </span>
                      </button>
                    </div>
                  </div>
